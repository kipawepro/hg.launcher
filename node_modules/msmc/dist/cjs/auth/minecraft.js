...
class Minecraft {
    ...
    getToken(full) {
        return {
            refresh: this.parent instanceof auth_js_1.Auth
                ? this.refreshTkn
    ...
    async entitlements() {
        var r998 = await (0, node_fetch_1.default)("https://api.minecraftservices.com/entitlements/mcstore", {
            headers: {
        ...
        (0, lexicon_js_1.errorResponse)(r998, "error.auth.minecraft.entitlements");
    ...
    mclc(refreshable) {
        return {
            ...
            meta: {
                ...
                exp: this.exp,
                refresh: refreshable
                    ? this.parent instanceof auth_js_1.Auth
                        ? this.refreshTkn
                        : this.parent.msToken.refresh_token
                    : undefined,
            },
    ...
    validate() {
        return (0, validate_js_1.validate)(this);
    }
    _parseLoginToken() {
