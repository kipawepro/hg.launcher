...
exports.LexiLoader = exports.loadLexiPack = exports.wrapError = exports.errorResponse = exports.error = exports.getCode = exports.lexicon = void 0;
...
exports.error = error;
function errorResponse(response, ts) {
    if (!response.ok)
        throw { response, ts };
}
