...
var firefox = false;
var start;
console.log("[MSMC]: OS Type => " + os_1.default.type());
            ...
            for (var i2 = 0; i2 < compatibleW.length; i2++) {
                for (var i = 0; i < pathsW.length; i++) {
                    ...
                    try {
                        ...
                        var out = (0, child_process_1.execSync)('"C:\\Windows\\System32\\reg.exe" query "' +
                            locW +
                            compatibleW[i2] +
                            '"').toString();
...
exports.default = (auth, Windowproperties = (0, common_js_1.getDefaultWinProperties)()) => {
    const cmd = Windowproperties.browserCMD ? Windowproperties.browserCMD : start;
    if (!cmd) {
        (0, lexicon_js_1.error)("error.gui.raw.noBrowser");
    }
